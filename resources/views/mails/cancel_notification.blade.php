...
<p style="text-align: center;font-size: 30px;">Hello <strong>{{ $transaction->user_name }} ,</strong></p>
<p style="text-align: center;">
	Sorry!!! We could not Verify your Payment. So Your Transaction: <strong>{{ $transaction->usd2bdt_transaction }}</strong> has been canceled.
</p>
 
<p style="text-align: center;color: 999;">
	Please try again and Complete your payment properly.
</p>
